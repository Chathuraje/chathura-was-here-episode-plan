...
- **Next (Chathura):** review the slate on `/chronology`, then choose locations per episode (Step 5). The release plan (Step 6) and screenplays (Step 8) follow the location choices.
